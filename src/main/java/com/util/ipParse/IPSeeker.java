...
public class IPSeeker {
    ...
    Logger logger = LogManager.getLogger(IPSeeker.class);
...
//        String address = country + " " + ipLocation.getArea();
        String address = ipLocation.getArea();
        return address.trim()+"\t"+country;
    }
...
//            System.out.println(IPSeeker.class.getResource("/"));
//            ipSeeker = IPSeeker.getInstance(new FileInputStream(new File("D:\\qqwry.dat")));
            ipSeeker = IPSeeker.getInstance();
        System.out.println(ipSeeker.getIPAdress("20.17.10.74"));
    }
}
