...
public class IPLocationUtil {
    ...
    public static Logger logger = LogManager.getLogger(IPLocationUtil.class);
    ...
    public static byte[] getByteArrayFromClasspathFile(String fileName){
        InputStream inputStream = getResourceAsStream(fileName, IPLocationUtil.class);
    ...
    public static InputStream getResourceAsStream(String fileName, Class<?> clazz) {
