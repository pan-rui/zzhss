...
public class ScanPayReqData implements Serializable {
     ...
     */
/*    public ScanPayReqData(String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String goodsTag){
