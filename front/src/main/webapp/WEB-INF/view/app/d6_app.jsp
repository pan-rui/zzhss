...
<%--                        <li>
                    ...
                    <p><img src="<c:url value="/images/appUseImg_10.jpg"/>" alt=""></p>
                    ...
                    <ul class="content-list content-list1">
                        <li>
                            ...
                            <p>
                                <img src="<c:url value="/images/appUseImg_13.jpg"/>" alt="">
                                <img src="<c:url value="/images/appUseImg_15.jpg"/>" alt="">
                            </p>
                        </li>
                    </ul>
                    ...
                    <ul class="content-list content-list1">
                        <li>
                            ...
                            <p>
                                <img src="<c:url value="/images/appUseImg_20.jpg"/>" alt="">
                            </p>
                        </li>
                    </ul>
                    ...
                    <ul class="content-list content-list1">
                        <li>
                            ...
                            <p>
                                <img src="<c:url value="/images/appUseImg_23.jpg"/>" alt="">
                                <img src="<c:url value="/images/appUseImg_25.jpg"/>" alt="">
                            </p>
                            <p>
                                <img src="<c:url value="/images/appUseImg_30.jpg"/>" alt="">
                                <img src="<c:url value="/images/appUseImg_33.jpg"/>" alt="">
                            </p>
                        </li>
                    </ul>
                    ...
                    <ul class="content-list content-list1">
                        <li>
                            ...
                            <p>
                                <img src="<c:url value="/images/appUseImg_38.jpg"/>" alt="">
                                <img src="<c:url value="/images/appUseImg_40.jpg"/>" alt="">
                            </p>
                        </li>
                    </ul>
                    ...
                    <ul class="content-list content-list1">
                        <li>
                            ...
                            <p>
                                <img src="<c:url value="/images/appUseImg_44.jpg"/>" alt="">
                                <img src="<c:url value="/images/appUseImg_46.jpg"/>" alt="">
                            </p>
                            <p>
                                <img src="<c:url value="/images/appUseImg_50.jpg"/>" alt="">
                            </p>
                        </li>
                    </ul>
                </div>
